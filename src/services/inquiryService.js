...
const inquiryService = {
    // Get all inquiries (admin) or filtered by specialty (doctor)
    ...
    // Get inquiries by specialty (doctors only)
    ...
    // Get inquiries by doctor (admin/doctor only)
    ...
    // Respond to inquiry (doctors only)
    ...
    // Respond to inquiry with files (doctors only)
    ...
    // Get inquiry analytics (admin only)
